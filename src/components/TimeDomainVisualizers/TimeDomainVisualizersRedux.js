...
const mapStateToProps = (state) => {
   ...
   */
  const uiComponentIds = memoizedStateQueries.getUiComponentIdsByType(state, 'TimeDomainAnalyser');
  return {
    /**
...
export const TimeDomainVisualizersRedux = connect(mapStateToProps)(TimeDomainVisualizersDumb);
