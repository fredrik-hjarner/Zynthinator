...
const DigitalLogic = () => (
  <MenuItem caption="Digital logic">
    <MenuItem caption="SchmittTrigger">
      <MenuItem caption="1. Knob input & thresholhold" onClick={() => importHistory(E.schmittTrigger.example1, 0)} />
      <MenuItem caption="2. Knob sine gain" onClick={() => importHistory(E.schmittTrigger.example2, 0)} />
    </MenuItem>
    <MenuItem caption="TwoWaySwitch">
      <MenuItem caption="1. Switching between triangle and sine" onClick={() => importHistory(E.twoWaySwitch.example1, 0)} />
    </MenuItem>
  </MenuItem>
);
...
const Distortions = () => (
  <MenuItem caption="Distortions">
    <MenuItem caption="CrossoverDistortion">
      ...
      <MenuItem caption="1. Square enables/disables distortion" onClick={() => importHistory(E.crossoverDistortion.example2, 0)} />
    </MenuItem>
  </MenuItem>
);
...
const Quantizers = () => (
  <MenuItem caption="Quantizers">
    <MenuItem caption="Quantizer">
      <MenuItem caption="1. Change resolution of sine with knob" onClick={() => importHistory(E.quantizer.example1, 0)} />
      <MenuItem caption="2. Triangle changing resolution of sine" onClick={() => importHistory(E.quantizer.example2, 0)} />
    </MenuItem>
    <MenuItem caption="TimeQuantizer">
      <MenuItem caption="1. Quantized noise" onClick={() => importHistory(E.timeQuantizer.example1, 0)} />
      <MenuItem caption="2. Playing random tones" onClick={() => importHistory(E.timeQuantizer.example2, 0)} />
      <MenuItem caption="3. Like 2. but sine modulates speed of melody" onClick={() => importHistory(E.timeQuantizer.example3, 0)} />
    </MenuItem>
  </MenuItem>
);
...
export const Examples = () => (
  <TopMenuItem caption="Examples">
    ...
    <MenuItem caption="Delay">
      <MenuItem caption="1. A sine and delayed sine summed" onClick={() => importHistory(E.delay.example1, 0)} />
      <MenuItem caption="2. As nr. 1 but delay is sine-modulated" onClick={() => importHistory(E.delay.example2, 0)} />
    </MenuItem>
    <DigitalLogic/>
    <Distortions/>
