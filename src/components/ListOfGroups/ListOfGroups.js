...
const ListOfGroups = (props) => {
  ...
  return (
    <SimpleWindow title="List of groups">
      {html}
    </SimpleWindow>
  );
};
...
const mapStateToProps = (state) => {
  const { nodes, groups } = state.nodeManagement;
...
const ListOfGroupsRedux = connect(mapStateToProps)(ListOfGroups);
