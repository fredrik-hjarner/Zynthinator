  ...
  <MenuItem caption="Distortions">
    <MenuItem caption="CrossoverDistortion">
      <MenuItem
        ...
        onClick={() => {
          // importHistory(E.crossoverDistortion.example1, 0);
        }}
      />
      <MenuItem
        caption="1. Square enables/disables distortion"
        onClick={() => {
          // importHistory(E.crossoverDistortion.example2, 0);
        }}
      />
    </MenuItem>
  </MenuItem>
  ...
  <MenuItem caption="Oscillators">
    <MenuItem caption="DigitalSequence">
      <MenuItem
        caption="1. Basic example"
        onClick={() => {
          // importHistory(E.digitalSequence.example1, 0);
        }}
      />
      <MenuItem
        caption="2. Noise drums"
        onClick={() => {
          // importHistory(E.digitalSequence.example2, 0);
        }}
      />
    </MenuItem>
    <MenuItem caption="LowResolutionSine">
      <MenuItem
        caption="1. Basic example"
        onClick={() => {
          // importHistory(E.lowResolutionSine.example1, 0);
        }}
      />
      <MenuItem
        caption="2. Frequency modulate an oscillator"
        onClick={() => {
          // importHistory(E.lowResolutionSine.example2, 0);
        }}
      />
    </MenuItem>
    <MenuItem caption="Sine">
      <MenuItem
        ...
        onClick={() => {
          // importHistory(E.sine.example1, 0);
        }}
      />
    </MenuItem>
  </MenuItem>
  ...
  <MenuItem caption="Quantizers">
    <MenuItem caption="Quantizer">
      <MenuItem
        ...
        onClick={() => {
          // importHistory(E.quantizer.example1, 0);
        }}
      />
      <MenuItem
        caption="2. Triangle changing resolution of sine"
        onClick={() => {
          // importHistory(E.quantizer.example2, 0);
        }}
      />
    </MenuItem>
    <MenuItem caption="TimeQuantizer">
      <MenuItem
        caption="1. Quantized noise"
        onClick={() => {
          // importHistory(E.timeQuantizer.example1, 0);
        }}
      />
      <MenuItem
        caption="2. Playing random tones"
        onClick={() => {
          // importHistory(E.timeQuantizer.example2, 0);
        }}
      />
      <MenuItem
        caption="3. Like 2. but sine modulates speed of melody"
        onClick={() => {
          // importHistory(E.timeQuantizer.example3, 0);
        }}
      />
    </MenuItem>
  </MenuItem>
...
export const Examples = () => (
  <TopMenuItem caption="Examples">
    <MenuItem caption="ADSR">
      <MenuItem
        caption="1. PWM triggers ADSR"
        onClick={() => {
          // importHistory(E.adsr.example1, 0);
        }}
      />
      <MenuItem
        caption="2. Knob triggers ADSR"
        onClick={() => {
          // importHistory(E.adsr.example2, 0);
        }}
      />
    </MenuItem>
    <MenuItem caption="ChangeRange">
      <MenuItem
        caption="1. Knob max val of sine"
        onClick={() => {
          // importHistory(E.changeRange.example1, 0);
        }}
      />
    </MenuItem>
    <MenuItem caption="Delay">
      <MenuItem
        ...
        onClick={() => {
          // importHistory(E.delay.example1, 0);
        }}
      />
      <MenuItem
        caption="2. As nr. 1 but delay is sine-modulated"
        onClick={() => {
          // importHistory(E.delay.example2, 0);
        }}
      />
    </MenuItem>
    <DigitalLogic />
    ...
    <MenuItem caption="Filters">
      <MenuItem
        caption="1. Low-pass filter"
        onClick={() => {
          // importHistory(E.filters.example1, 0);
        }}
      />
      <MenuItem
        caption="2. High-pass filter"
        onClick={() => {
          // importHistory(E.filters.example2, 0);
        }}
      />
      <MenuItem
        caption="3. Band-pass filter"
        onClick={() => {
          // importHistory(E.filters.example3, 0);
        }}
      />
    </MenuItem>
    <Oscillators />
